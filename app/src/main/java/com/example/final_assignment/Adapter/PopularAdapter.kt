...
import com.example.final_assignment.activity.DetailActivity
//import com.example.final_assignment.activity.DetailActivity
import com.example.final_assignment.databinding.ViewholderRecommendedBinding
...
class PopularAdapter(val items: MutableList<ItemsModel>) :
    ...
    override fun onBindViewHolder(holder: PopularAdapter.ViewHolder, position: Int) {
        ...
        holder.binding.priceTxt.text = "RM" + items[position].price.toString()
